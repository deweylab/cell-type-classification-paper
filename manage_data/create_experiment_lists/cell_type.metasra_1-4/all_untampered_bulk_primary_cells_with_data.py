...
def main():
    ...
    annotation_f = args[0]
    #annotation_f = "/ua/mnbernstein/projects/tbcp/phenotyping/manage_data/annotations/from.cell_type_primary_cells_v1-4/cell_type_primary_cells_v1-4.annot_1-1.experiment_centric.json"
    #annotation_f = "/ua/mnbernstein/projects/tbcp/phenotyping/manage_data/annotations/from.cell_type_primary_cells_v1-4/cell_type_primary_cells_v1-4.annot_2-1.experiment_centric.json"
        ...
        f.write(json.dumps(
            {
                ...
                "description": "These are all experiments that are not labelled with %s, but allows those labelled with %s.  All of these samples can be found in the database." % (
                    list(EXCLUDE_TAGS), 
