...
PLOTS_BY_STUDY = True
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:0000681"]),  # glial cell
    frozenset(["CL:0002321"])   # embryonic cell
])
"""
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:0002319"]),  # neural cell
    frozenset(["CL:0002321"])   # embryonic cell
])
"""
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:0000083"])   # epithelial cell of pancreas
])
"""
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:0002079"])   # pancreatic ductal cell
])
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:0000173"])
])
"""
PLOT_LABEL_SET = frozenset([
    frozenset(["CL:2000043"]),  # brain pericyte
    frozenset(["CL:0002321"])   # embryonic cell
])
"""
...
def main():
    ...
    plot_exps = [
        ...
        and frozenset(exp_to_ms_labels[exp]) == PLOT_LABEL_SET
    ]
    plot_exps = random.sample(plot_exps, min([len(plot_exps), 15]))
    print "Plotting %d experiments" % len(plot_exps)
